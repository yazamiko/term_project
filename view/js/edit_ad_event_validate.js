function sendData() {
    ...
    var url = "../controller/edit_ad_event_controller.php";
    xmlhttp.open("POST", url, true);

    var params = "event_code=" + document.getElementById("eventCode").value +
    		"&event_name=" + document.getElementById("adName").value +
    		"&start_date=" + document.getElementById("startDate").value +
    		"&end_date=" + document.getElementById("endDate").value +
    		"&ad_description=" + document.getElementById("adDescription").value +
    ...
    $('#myModal').modal('show');
   	...
   	if(arr.status) {
   		$( "#modalButton" ).click(function() {
  			location.href = "../view/ad_event_page.html?eventCode=" + document.getElementById("eventCode").value;
		});
   	}
}
...
{
	var eCode = document.getElementById("eventCode").value;
